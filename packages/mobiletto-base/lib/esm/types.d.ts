...
import { MobilettoListOptions, MobilettoMetadata, MobilettoMinimalClient, MobilettoMirrorResults, MobilettoOptions, MobilettoRedisConfig, MobilettoWriteSource, MobilettoVisitor, MobilettoListOutput } from "mobiletto-common";
...
export type MobilettoClient = MobilettoConnection & {
    ...
    flush: () => Promise<void>;
    driver_list: (path?: string, optsOrRecursive?: MobilettoListOptions, visitor?: MobilettoVisitor) => Promise<MobilettoListOutput>;
