...
export class MobilettoCache {
    constructor(name, host = "127.0.0.1", port = 6379, prefix = "_mobiletto__") {
        ...
        this.doRedisAsync = (func_1, ...args_1) => __awaiter(this, [func_1, ...args_1], void 0, function* (func, defaultValue = null) {
            try {
        ...
        this.set = (key_1, val_1, ...args_2) => __awaiter(this, [key_1, val_1, ...args_2], void 0, function* (key, val, expirationMillis = DEFAULT_EXPIRATION_MILLIS) {
            this.counters.set++;
            if (logger.isTraceEnabled())
